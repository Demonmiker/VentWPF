...
namespace K3G_DLL
{
    public partial class Form1 : Form
    {
        ...
        {
            double Volumenstrom = Convert.ToDouble(VFlow.Text) / 3600;        //VFlow    
            ...
            Input_Data = ID + ';' + // the ID // die ID                    // Setze alle Informationen in den String und fülle es mit Semikolon um weitere Informationen zu bekommen
                         ...
                         InstType.Text + ';' +                                 // InstallationType(0:DIDO,1:FIDO,2:DIFO,3:FIFO) 
                         Des.Text + ';' +                                            // AirDensity(kg/m³) 
                         "0" + ';' +                                          // The altitude 
                         "24" + ';' +                                             // AirTemperature(°C) 
                         PD + ';' +                                        // requiredPressure(Pa)
