namespace VentWPF.FanDLL
{
    public class FanData
    {
        ...
        public string INSTALLATION_HEIGHT_MM { get; set; }
        public string INSTALLATION_WIDTH_MM { get; set; }
        ...
        public string POWER_OUTPUT_HP { get; set; }
